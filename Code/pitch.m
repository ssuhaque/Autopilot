...
% PITCH Application M-file for pitch.fig
%    FIG = PITCH launch pitch GUI.
%    PITCH('callback_name', ...) invoke the named callback.

% Last Modified by GUIDE v2.0 02-Jul-2002 02:33:56
...
% --------------------------------------------------------------------
function varargout = tfvg_Callback(h, eventdata, handles, varargin)
% Stub for Callback of the uicontrol handles.tfvg.
global tfvg;
global reqtf;
reqtf=tfvg;
tfunction;
